...
function cashDrawerV2Close(){
  const shift=cashDrawerStore.activeShift;if(!shift)return;
  const name=($('#drawer-v2-close-name')?.value||'').trim()||shift.openedBy||'ผู้รับผิดชอบ';
